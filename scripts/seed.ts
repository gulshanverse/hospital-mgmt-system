...
async function main() {
  ...
  try {
    ...
    console.warn(
      "[Seed] Cleanup warning (tables might be empty or missing):",
      error
    );
  }
  ...
  const deptData = [
    {
      ...
      description: "Immediate treatment for acute illnesses and trauma.",
    },
    {
      name: "General Medicine",
      description: "Primary care, outpatient clinic, and general evaluations.",
    },
    {
      name: "Cardiology",
    ...
    {
      name: "Pediatrics",
      description: "Comprehensive medical care for children and infants.",
    },
    {
      name: "Neurology",
      description: "Treatment of brain and spinal cord disorders.",
    },
    {
      name: "Radiology",
      description: "Medical imaging including MRI, CT scans, and X-ray.",
    },
    {
      name: "Pharmacy",
      description: "Hospital dispensary and medication management.",
    },
    {
      name: "Surgery",
    ...
    },
    {
      ...
      description: "Maternity care, women's health, and childbirth services.",
    },
    {
      name: "Oncology",
      description: "Cancer treatment, chemotherapy, and clinical oncology.",
    },
    {
      name: "Pathology",
      description:
        "Diagnostic lab tests, blood chemistry, and tissue analysis.",
    },
  ];
  ...
  console.log(
    `[Seed] Seeded ${wardData.length} wards and ${allBedIds.length} beds.`
  );
  ...
  const mainUsers = [
    ...
    {
      name: "Pharmacist David Green",
      email: "david.green@hms.com",
      phone: "9876543214",
    ...
    {
      name: "Technician Edward Nygma",
      email: "edward.n@hms.com",
      phone: "9876543215",
    ...
    {
      name: "Receptionist Fiona Gallagher",
      email: "fiona.g@hms.com",
      phone: "9876543216",
  ...
  const pharmacistUserId = (await db.insert(users).values(mainUsers[2]))[0]
    .insertId;
  const techUserId = (await db.insert(users).values(mainUsers[3]))[0].insertId;
  const receptionistUserId = (await db.insert(users).values(mainUsers[4]))[0]
    .insertId;
  ...
  const docNames = [
    ...
    },
    {
      ...
      deptId: surgeryDeptId,
      license: "LIC-SURG-010",
    },
    {
      name: "Dr. Karen Page",
      email: "karen.p@hms.com",
      specialty: "Clinical Pathology",
      deptId: pathologyDeptId,
      license: "LIC-PAT-011",
    },
    {
      name: "Dr. Leo DiCaprio",
      email: "leo.d@hms.com",
      specialty: "Child Neuropsychiatry",
      deptId: pediatricsDeptId,
      license: "LIC-PED-012",
    },
    {
      name: "Dr. Maggie Smith",
      email: "maggie.s@hms.com",
      specialty: "Chemotherapy & Oncology",
      deptId: oncologyDeptId,
      license: "LIC-ONC-013",
    },
    {
      name: "Dr. Nathan Drake",
      email: "nathan.d@hms.com",
  ...
  const fees = [
    150, 200, 175, 100, 250, 180, 300, 275, 225, 120, 160, 190, 280, 320, 140,
  ];
  ...
  const staffTypes = [
    {
      role: "nurse" as const,
      pos: "Ward Nurse",
      qualifications: "RN, B.Sc Nursing",
      deptId: generalDeptId,
    },
    {
      role: "nurse" as const,
      pos: "ICU Specialist Nurse",
      qualifications: "Critical Care Cert",
      deptId: generalDeptId,
    },
    {
      role: "nurse" as const,
      pos: "Maternity Assistant",
      qualifications: "Certified Midwife",
      deptId: obgynDeptId,
    },
    {
      role: "lab_technician" as const,
      pos: "Senior Pathology Tech",
      qualifications: "DMLT, B.Sc Lab Tech",
      deptId: pathologyDeptId,
    },
    {
      role: "lab_technician" as const,
      pos: "MRI/CT Radiographer",
      qualifications: "Radiologic Technologist",
      deptId: radiologyDeptId,
    },
    {
      role: "pharmacist" as const,
      pos: "Inpatient Dispensary Lead",
      qualifications: "M.Pharm",
      deptId: pharmacyDeptId,
    },
    {
      role: "receptionist" as const,
      pos: "Help Desk Associate",
      qualifications: "High School, Admin Cert",
      deptId: generalDeptId,
    },
  ];
  ...
  await db
    ...
    .values({
      userId: techUserId,
      departmentId: pathologyDeptId,
      position: "Lab Administrator",
      qualifications: "Ph.D Clinical Bio",
      isActive: true,
    });
  ...
  for (let i = 1; i <= 50; i++) {
    ...
    const [res] = await db.insert(patients).values({
      ...
      insuranceProvider:
        i % 3 === 0 ? "Aetna" : i % 3 === 1 ? "BlueCross" : "Medicare",
  ...
  await db.insert(admissions).values({
    ...
    notes:
      "Requires continuous cardiac telemetry. Keep elevated head position.",
  ...
  await db
    .update(beds)
    .set({ status: "occupied" })
    .where(eq(beds.id, occupiedIcuBedId));
  ...
  const appointmentDates = [
    {
      ...
      departmentId: cardiologyDeptId,
      appointmentDate: new Date("2026-07-04"),
    ...
    },
    {
      ...
      departmentId: neurologyDeptId,
      appointmentDate: new Date("2026-07-05"),
    ...
    },
    {
      ...
      doctorId: doctorIds[0],
      departmentId: cardiologyDeptId,
      appointmentDate: new Date("2026-07-03"),
  ...
  const [mr] = await db.insert(medicalRecords).values({
    ...
    content:
      "ECG shows transient ischemic changes. Symptoms present on exertion. Prescribed vasodilator and cardiac follow-up.",
  ...
  await db.insert(labReports).values({
    ...
    reportDate: new Date(),
    results:
      "Troponin I: <0.01 ng/mL (Normal), CK-MB: 2.1 ng/mL (Normal), Total Cholesterol: 195 mg/dL, HDL: 45 mg/dL, LDL: 120 mg/dL.",
  ...
  const drugs = [
    ...
    },
    {
      ...
      batchNumber: "B-MET-22",
      quantity: 10,
      unitPrice: "0.20",
      reorderLevel: 60,
      expiryDate: new Date("2027-02-15"),
      storageLocation: "Cabinet C",
    ...
    },
    {
      ...
      category: "Statins",
      manufacturer: "Pfizer",
      batchNumber: "B-ATR-88",
      quantity: 8,
      unitPrice: "1.10",
      reorderLevel: 40,
      expiryDate: new Date("2027-11-20"),
      storageLocation: "Cabinet D",
      status: "low_stock" as const,
    },
    {
      drugCode: "DRG-005",
    ...
    },
    {
      ...
      manufacturer: "Sandoz",
      batchNumber: "B-LIS-11",
      quantity: 450,
      unitPrice: "0.35",
      reorderLevel: 50,
      expiryDate: new Date("2028-10-30"),
      storageLocation: "Cabinet E",
      status: "available" as const,
    },
  ];
  ...
  await db.insert(notifications).values({
    ...
    message:
      "Atorvastatin 10mg is low on stock (8 units). Please schedule reorder.",
    relatedEntityId: 4,
  ...
  await db.insert(auditLogs).values({
    ...
    changes: JSON.stringify({
      status: "CareFlow HMS initialized with full active production data.",
    }),
    ipAddress: "127.0.0.1",
