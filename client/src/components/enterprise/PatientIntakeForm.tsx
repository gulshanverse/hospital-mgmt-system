        ...
        <form onSubmit={methods.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="p-4 border border-amber-200 bg-amber-50/50 rounded-xl flex items-start gap-3 text-sm text-amber-900 animate-in fade-in zoom-in-95 duration-150">
              ...
              <div className="flex-1 space-y-2">
                ...
                <p className="text-xs text-amber-800 leading-relaxed">
                  {duplicateWarning.message}. If you want to bypass validation
                  and register this record anyway, click "Force Registration".
                </p>
          ...
          {currentStep === 0 && (
            <SectionCard
              ...
              description="Provide standard patient registration variables."
            >
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              <SectionCard
                ...
                description="Link policies and primary provider data."
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-foreground">
                    ...
                    <Input
                      {...methods.register("insuranceProvider")}
              ...
              <SectionCard
                ...
                description="Emergency family relations contacts."
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-foreground">
