...
export default function Dashboard() {
  ...
  const { data: kpis, isLoading: kpisLoading } =
    trpc.analytics.getDashboardKPIs.useQuery(undefined, {
      enabled: isAdmin,
    });
  const { data: weeklyAdmissions } =
    trpc.analytics.getWeeklyAdmissions.useQuery(undefined, {
      enabled: isAdmin,
    });
  ...
  const { data: appointmentTrends } =
    trpc.analytics.getAppointmentTrends.useQuery(undefined, {
      enabled: isAdmin,
    });
        ...
        <div className="space-y-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-yellow-700">
                    Verify your email to ensure secure account access and
                    recoverability.
                  </p>
                </div>
              </div>
          ...
          <Card className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
            <h1 className="text-2xl font-bold text-blue-900">
              Welcome to JeevanOS, {user?.fullName || "User"}!
            </h1>
            <p className="text-blue-700 mt-2">
              You are logged in as{" "}
              <span className="font-semibold capitalize">{user?.role}</span>.
              Access the sidebar navigation to view and manage features allowed
              for your role.
            </p>
          </Card>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-yellow-900">
                      {kpis.lowStockMedicines} Low Stock Items
                    </p>
                    <p className="text-sm text-yellow-700">
                      Pharmacy inventory needs attention
                    </p>
                  </div>
                </div>
              </Card>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-red-900">
                      {kpis.pendingBills} Pending Bills
                    </p>
                    <p className="text-sm text-red-700">
                      Outstanding invoices require payment
                    </p>
                  </div>
                </div>
              </Card>
        ...
        <Tabs defaultValue="revenue" className="w-full">
          ...
          <TabsContent value="revenue" className="mt-4">
            <ChartContainer
              ...
              description="Total revenue generated per month in USD"
            >
          ...
          <TabsContent value="admissions" className="mt-4">
            <ChartContainer
              ...
              description="New patient hospitalizations per week"
            >
              <ResponsiveContainer width="100%" height="100%">
          ...
          <TabsContent value="appointments" className="mt-4">
            <ChartContainer
              ...
              description="Current share of appointments categorized by status"
            >
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
